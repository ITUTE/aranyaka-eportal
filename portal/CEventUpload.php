...
<html>
<head>
	<title>Circular Event Upload</title>
...
<body>
    ...
    <div class="container-fluid bg-3 text-center slide">    
        ...
        <div class="row slide">
            ...
            <p><font size=3px>Please hit the<strong> Go Back </strong>button once you're done uploading to return to the home page.<br><strong> Thank you for uploading materials to help us students!</strong></font></p>
        </div> 
    </div>
