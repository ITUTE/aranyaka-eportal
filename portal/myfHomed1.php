			...
			<div id="groups" class="tab-pane fade">
			    <div class="container-fluid bg-3">
					<div class="row slide">
						...
						<p class='text-center'><font size=3px>Here you can view all the groups you are associated with.</font></p><br>
                        <?php 
			...
			<div id="delete" class="tab-pane fade">
           		<div class="container-fluid bg-3 text-center">
					...
					<div class="row slide">
						...
						<p><font size=3px>Here you can view all the materials uploaded by members of faculty,<br> with the additional feature of deleting the ones uploaded by you</font></p><br>
                  	</div>
            	</div>
        	</div>
