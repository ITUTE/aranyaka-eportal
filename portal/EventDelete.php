    ...
    <div class="container-fluid slide">
        <div class="row">
            <?php
                ...
                {
					echo "<p style=\"text-align:center\"><font color=\"darkcyan\" size=5px face = \"Comic sans MS\">Sir/Ma'am, no event has been uploaded by you!</font></p>";
                    die();
                }
	...
	<script>
		function del(id)
		{
			if (confirm("Confirm") == true) {
				location.assign("EDeleteFile.php?id="+id);
			} 
			else {
				die();
			}
