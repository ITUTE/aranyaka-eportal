    ...
    <div class="container-fluid bg-3">
        ...
        <form class="form-horizontal" method="POST">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="usn">Enter Student's USN:</label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="field">
                      <option value="stu_usn">USN</option>
                      <option value="stu_name">Name</option>
                      <option value="stu_sem_code">Semester</option>
...
<?php
    ...
    //      echo $_SESSION['usn'];
          ...
          header("Location: modifyAttrStudent.php");
}
